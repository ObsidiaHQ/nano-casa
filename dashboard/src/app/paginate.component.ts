...
@Component({
    ...
    template: `
        ...
        <li class="page-item mx-2" [ngClass]="{disabled:pager.currentPage === 1}">
            <a class="page-link" tabindex="-1" (click)="setPage(pager.currentPage - 1)">
        ...
        <li *ngFor="let page of [].constructor(pager.totalPages); let i = index" 
            class="page-item" [ngClass]="{active:pager.currentPage === i+1}">
            <a class="page-link" (click)="setPage(i+1)">{{i+1}}</a>
        </li>
        <li class="page-item mx-2" [ngClass]="{disabled:pager.currentPage === pager.totalPages}">
